...
>      {/* Image with circle border */}
      ...
      {/* Name and Title */}
      <div>
        <h2 className="text-cyan-600 font-bold text-lg tracking-wide">ND</h2>
  ...
  <div className="space-y-4">
    <p className="indent-6">
      <strong>Hello, I'm Captain NDimage.png</strong> and I want to tell you about my typing Website <strong>MPCPCT</strong>. It is a simple and convenient online typing tutor for everybody who wants to type better.
    </p>
    <p className="indent-6">
