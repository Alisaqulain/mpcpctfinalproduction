...
>      {/* Image with circle border */}
  ...
  <div className="space-y-4">
    <p className="indent-6">
      <strong>Hello, I'm Captain ND</strong> and I want to tell you about my typing Website <strong>MPCPCT</strong>. It is a simple and convenient online typing tutor for everybody who wants to type better.
    </p>
    <p className="indent-6">
