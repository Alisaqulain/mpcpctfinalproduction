    ...
    return NextResponse.json({
      ...
      data: {
        exam: {
          ...
          isFree: exam.isFree,
          subCategoryId: exam.subCategoryId ? String(exam.subCategoryId) : null,
          durationMinutes: exam.durationMinutes ?? exam.totalTime,
          totalMarks: exam.totalMarks,
          passingMarks: exam.passingMarks,
          negativeMarking: exam.negativeMarking,
          hasTypingSection: exam.hasTypingSection,
          typingTimeMinutes: exam.typingTimeMinutes,
          instructions: exam.instructions || "",
          passingRules: exam.passingRules || null,
