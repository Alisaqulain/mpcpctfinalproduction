  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="bg-[#290c52] p-4 rounded-lg border border-[#ffffff40]">
      ...
      <div ref={lessonSectionRef} className="flex flex-row bg-blue-200 bg-[url('/bg.jpg')] pb-10 md:pb-16">
        ...
        <div className="w-[20%] min-w-0 flex-shrink-0 md:w-40 bg-transparent text-white pt-14 pl-1 md:pl-6 flex flex-col gap-8 md:gap-[3rem] text-[12px] md:text-2xl learning-sidebar-sections">
          {learningData.sections?.map((section, index) => (
            <p
              ...
              className={`cursor-pointer py-1.5 md:py-2 rounded-md md:rounded-full mr-1 md:mr-3 learning-sidebar-item font-bold leading-tight ${
            ...
            >
              ...
              <span className="ml-0.5 md:ml-2 font-bold">{section.name}</span>
            </p>
          ))}
        </div>
